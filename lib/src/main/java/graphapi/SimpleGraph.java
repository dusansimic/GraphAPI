...
public class SimpleGraph implements Graph {
   ...
   */
  public SimpleGraph(In in) throws NumberFormatException, IOException {
    this(in.readInt());
    int e = in.readInt();
    edges = 0;
   ...
   */
  public static SimpleGraph induceByVertices(SimpleGraph g, int[] vertices) {
    SimpleGraph newGraph = new SimpleGraph(g);
   ...
   */
  public static SimpleGraph induceByEdges(SimpleGraph g, Edge[] edges) {
    SimpleGraph newGraph = new SimpleGraph(g);
   ...
   */
  public static SimpleGraph induceKCore(SimpleGraph g, int[] cores, int k) {
    SimpleGraph newGraph = new SimpleGraph(g);
